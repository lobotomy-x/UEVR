...
void Framework::draw_ui() {
    ...
    ImGui::PushStyleColor(ImGuiCol_WindowBg, ImVec4(0.1f, 0.1f, 0.1f, 1.0f)); // Dark Grey, Opaque
    ImGui::Begin("External Viewport Test");
    ImGui::Text("If you see this, the swapchain is alive.");
    ImGui::End();
    ImGui::PopStyleColor();
    ImGui::PopStyleVar();
